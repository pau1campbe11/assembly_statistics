...
#SBATCH --job-name=repeatmod_dviv  # some descriptive job name of your choice
...
BuildDatabase -name d.viviparus_db /users/2320707c/project0005/for_paul_oster/ref_genomes/GCA_964187775.1_ngDicVivi2.1_genomic.fna

RepeatModeler -database d.viviparus_db -threads 15 -LTRStruct > out.log
