...
#SBATCH --job-name=repeatmod_oster  # some descriptive job name of your choice
...
BuildDatabase -name o.ostertagia_db /users/2320707c/project0005/for_paul_oster/ref_genomes/GCA_964213955.1_nxOstOste4.1_genomic.fna

RepeatModeler -database o.ostertagia_db -threads 15 -LTRStruct > out.log
