...
#SBATCH --job-name=busco_nbat     # some descriptive job name of your choice
...
busco -i /users/2320707c/project0005/for_paul_oster/ref_genomes/nxNemBatt_draft.fa -l nematoda_odb10 -o n.bat_nematoda_odb10 -m genome -c 10 
