...
#SBATCH --job-name=repeatmod_tcol # some descriptive job name of your choice
...
BuildDatabase -name t.colubriformis_db /users/2320707c/project0005/for_paul_oster/ref_genomes/GCA_963978905.1_nxTriColu2.1_genomic.fna 

RepeatModeler -database t.colubriformis_db -threads 15 -LTRStruct > out.log
