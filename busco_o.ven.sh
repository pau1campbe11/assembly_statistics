...
#SBATCH --job-name=busco_oven      # some descriptive job name of your choice
...
conda activate busco_5.8.2

############# MY CODE #############

busco -i /users/2320707c/project0005/for_paul_oster/ref_genomes/nxOesVenu3_draft.fa -l nematoda_odb10 -o o.ven_nematoda_odb10 -m genome -c 10 
